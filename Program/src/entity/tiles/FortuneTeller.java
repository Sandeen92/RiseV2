...
/**
 * Fortune teller class, either returns a fortune where the entity.player
...
public class FortuneTeller implements Tile, Serializable {
	...
	public String getTileInfo() {
		return "There are two types of cards, blessings and curses." + 
				"\nBlessing affect the entity.player in a positive way." +
				"\nCurses affect the entity.player in a negative way.";
	}
